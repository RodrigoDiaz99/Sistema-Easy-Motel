    ...
    <div class="container-fluid">
        <header class="card px-2 py-4">
            <div class="d-flex justify-content-between align-items-center">
                <a href="{{ route('establishment.index') }}" class="btn btn-icon btn-danger">
        ...
        <div class="card px-2 mt-4 py-4">
            <form class="form px-3" id="storehotel">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-4">
                                ...
                                <input class="form-control form-control-alternative" id="name"
                                    placeholder="Nombre del Establecimiento" type="text">
                            </div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <label for="">Ubicacion Establecimiento</label>
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-4">
                                <span class="input-group-text"><i class="ni ni-zoom-split-in"></i></span>
                                <input class="form-control form-control-alternative" id="location"
                                    placeholder="ubicacion del Establecimiento" type="text">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="">Capacidad Establecimiento</label>
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-4">
                                <span class="input-group-text"><i class="ni ni-zoom-split-in"></i></span>
                                <input class="form-control form-control-alternative" id="capacity"
                                    placeholder="Capacidad del Establecimiento" type="number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-4">
                                <span class="input-group-text"><i class="ni ni-zoom-split-in"></i></span>
                                <select class="form-control" name="" id="  establishment_areas_id">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-4">
                                <span class="input-group-text"><i class="ni ni-zoom-split-in"></i></span>
                                <select class="form-control" name="" id="owner">
                                    <option value="" disabled selected>Seleccione tipo</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                <span class="input-group-text"><i class="ni ni-zoom-split-in"></i></span>
                                <input class="form-control form-control-alternative" placeholder="Shelly Auth key"
                                    type="text">
                            </div>
                            <span><small class="text-danger">* Este campo puede quedar vacio.</small></span>
                        </div>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-6" id="select_id">
                        <div class="d-flex justify-content-between align-items-center">
                            <label for="">Areas Establecimiento</label>
                    ...
                    <select class="form-control" name="establishment_types_id">
                            ...
                            @foreach ($establishment_area as $row)
                    ...
                    <div class="col-md-6">
                        <label class="mb-4" for="">Descripcion</label>
                        <textarea style="resize: none" class="form-control" id="exampleFormControlTextarea1"
                            placeholder="Descripcion del Establecimiento" rows="4"></textarea>
                    </div>
                </div>

                <section id="rooms">
                    <div class="border-bottom mt-4 d-flex justify-content-between align-items-center">
                        <h5 class="h5">Habitaciones</h5>

                        <button type="button" class="btn btn-icon btn-success d-flex align-items-center"
                            data-bs-toggle="modal" data-bs-target="#addRooms">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
@section('scripts')
    <script>
        let url = "{{ route('establishment.store') }}"
        let url_area = "{{ route('area.store') }}"
        let url_area_data = "{{ route('area.index') }}";
    </script>


    <script src="{{ asset('js/establishment/create.js') }}"></script>
    <script src="{{ asset('js/establishment/areas.js') }}"></script>
@endsection

{{-- Modals --}}
@include('rooms.extras.modals.create')
@include('shellies.extras.modals.create')
@include('areas.extras.modals.createArea')
