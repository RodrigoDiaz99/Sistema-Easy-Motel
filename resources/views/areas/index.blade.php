    ...
    <div class="container-fluid">
        <header class="card px-2 py-4">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="h2 ms-3">Areas</h3>

                <a href="{{ route('area.create') }}" class="btn btn-icon btn-success d-flex align-items-center">
                    ...
                    <span class="btn-inner--text">Agregar Area</span>
                </a>
            </div>
        </header>
            ...
            <div class="row gx-2 gy-4">
                ...
                @empty
                        ...
                        <svg height="179" viewBox="0 0 315 179" width="315" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <g transform="translate(25)">
                                    <rect fill="#fff" height="175" rx="10" stroke="#eee" stroke-width="4" width="274" x="2"
                                        y="2" />
                    ...
                    <div class="text-center mt-3">
                        <strong class="h4 text-danger">NO HAY AREAS PARA MOSTRAR</strong>
                    </div>
                @endforelse
            </div>
        </div>
